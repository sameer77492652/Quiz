...
public class MainActivityNew04042018 extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    private void initListener() {
        ...
        tvSkipQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (count == (questionListNew.size()) - 1) {
                    ...
                    Intent intent = new Intent(MainActivityNew04042018.this, ThankuActivity.class);
        ...
        tvEnglish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                config.locale = locale;
                getBaseContext().getResources().updateConfiguration(config, getBaseContext().getResources().getDisplayMetrics());
                userDetailsPref.putStringPref(MainActivityNew04042018.this, UserDetailsPref.LANGUAGE_TYPE, english);
                tvQuiz.setText(getResources().getText(R.string.activity_do_you_know));
                tvSkipQuestion.setText(getResources().getText(R.string.activity_skip));
    ...
    private void isLogin() {
        if (userDetailsPref.getStringPref(MainActivityNew04042018.this, UserDetailsPref.USER_EMAIL).equalsIgnoreCase("")) {
            Intent intent = new Intent(MainActivityNew04042018.this, LoginActivity.class);
            startActivity(intent);
    ...
    private void initData() {
        ...
        tvTitle.setText(userDetailsPref.getStringPref(MainActivityNew04042018.this, UserDetailsPref.USER_NAME));
        tvScore.setText("Earned Score: " + userDetailsPref.getIntPref(MainActivityNew04042018.this, UserDetailsPref.USER_TOTAL_AMOUNT));
...
//        android.os.Process.killProcess(android.os.Process.myPid());
    ...
    private void getQuestionlistNew() {
        if (NetworkConnection.isNetworkAvailable(MainActivityNew04042018.this)) {
            ...
            StringRequest strRequest1 = new StringRequest(Request.Method.GET, AppConfigURL.URL_QUESTION_NEW,
                    new com.android.volley.Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            userDetailsPref.putStringPref(MainActivityNew04042018.this, UserDetailsPref.RESPONSE
                            ,response);
                            if (response != null) {
                                try {
                                    ...
                                    if (!error) {
                                        ...
                                        Utils.showSnackBar(MainActivityNew04042018.this, clMain, message, Snackbar.LENGTH_LONG, null, null);
                                    }
                                    progressDialog.dismiss();
                                } catch (Exception e) {
                                    progressDialog.dismiss();
                                    Utils.showSnackBar(MainActivityNew04042018.this, clMain, getResources().getString(R.string.snackbar_text_exception_occurred), Snackbar.LENGTH_LONG, getResources().getString(R.string.snackbar_action_dismiss), null);
                                    e.printStackTrace();
                                }
                            } else {
                                Utils.showSnackBar(MainActivityNew04042018.this, clMain, getResources().getString(R.string.snackbar_text_error_occurred), Snackbar.LENGTH_LONG, getResources().getString(R.string.snackbar_action_dismiss), null);
    ...
    private void questionListOption() {
        ...
        pieView.setPercentageTextSize(Utils.pxFromDp(MainActivityNew04042018.this, 8));
        ...
        tvOptionA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (questionListNew.get(k).getQuestionOptionListNew().get(j).getId() == questionListNew.get(k).getCorrect_id()) {
                    ...
                    if (userDetailsPref.getIntPref(MainActivityNew04042018.this, UserDetailsPref.USER_TOTAL_AMOUNT) != 0) {
                        userDetailsPref.putIntPref(MainActivityNew04042018.this, UserDetailsPref.USER_TOTAL_AMOUNT, userDetailsPref.getIntPref(MainActivityNew04042018.this, UserDetailsPref.USER_TOTAL_AMOUNT) + Integer.parseInt(questionListNew.get(k).getPoints()));
                    } else {
                        userDetailsPref.putIntPref(MainActivityNew04042018.this, UserDetailsPref.USER_TOTAL_AMOUNT, Integer.parseInt(questionListNew.get(k).getPoints()));
                    }
    ...
    private void initDrawer() {
        ...
        if (userDetailsPref.getStringPref (MainActivityNew04042018.this, UserDetailsPref.PROFILE).length () != 0) {
            headerResult = new AccountHeaderBuilder()
                    .withActivity(this)
                    .withCompactStyle(false)
                    .withTypeface(SetTypeFace.getTypeface(MainActivityNew04042018.this))
            ...
            headerResult.addProfiles(new ProfileDrawerItem()
                    .withIcon(userDetailsPref.getStringPref(MainActivityNew04042018.this, UserDetailsPref.PROFILE))
                    .withName(userDetailsPref.getStringPref(MainActivityNew04042018.this, UserDetailsPref.USER_NAME))
                    .withEmail(userDetailsPref.getStringPref(MainActivityNew04042018.this, UserDetailsPref.USER_EMAIL)));
        }else{
            headerResult = new AccountHeaderBuilder()
                    .withActivity(this)
                    .withCompactStyle(false)
...
//                .withItemAnimator (new AlphaCrossFadeAnimator ())
                ...
                .addDrawerItems(
                        new PrimaryDrawerItem().withName("Home").withIcon(FontAwesome.Icon.faw_home).withIdentifier(1).withTypeface(SetTypeFace.getTypeface(MainActivityNew04042018.this)),
                        new PrimaryDrawerItem().withName("My Account").withIcon(FontAwesome.Icon.faw_user).withIdentifier(2).withSelectable(false).withTypeface(SetTypeFace.getTypeface(MainActivityNew04042018.this)),
                        new PrimaryDrawerItem().withName("Faqs").withIcon(FontAwesome.Icon.faw_question).withIdentifier(3).withSelectable(false).withTypeface(SetTypeFace.getTypeface(MainActivityNew04042018.this)),
                        new PrimaryDrawerItem().withName("Refer").withIcon(FontAwesome.Icon.faw_share).withIdentifier(4).withSelectable(false).withTypeface(SetTypeFace.getTypeface(MainActivityNew04042018.this)),
                        new PrimaryDrawerItem().withName("Earned Points").withIcon(FontAwesome.Icon.faw_phone).withIdentifier(5).withSelectable(false).withTypeface(SetTypeFace.getTypeface(MainActivityNew04042018.this)),
                        new PrimaryDrawerItem().withName("Winner List").withIcon(FontAwesome.Icon.faw_trophy).withIdentifier(8).withSelectable(false).withTypeface(SetTypeFace.getTypeface(MainActivityNew04042018.this)),
                        ...
                        new PrimaryDrawerItem().withName("Enquiry").withIcon(FontAwesome.Icon.faw_phone).withIdentifier(7).withSelectable(false).withTypeface(SetTypeFace.getTypeface(MainActivityNew04042018.this)),
                        new PrimaryDrawerItem().withName("Sign Out").withIcon(FontAwesome.Icon.faw_sign_out).withIdentifier(6).withSelectable(false).withTypeface(SetTypeFace.getTypeface(MainActivityNew04042018.this))
                )
                .withSavedInstance(savedInstanceState)
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        switch ((int) drawerItem.getIdentifier()) {
                            case 2:
                                Intent intentSubmitAd = new Intent(MainActivityNew04042018.this, ProfileUpdateActivity.class);
                                startActivity(intentSubmitAd);
                                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
                                break;

                            case 3:
                                Intent intentFaq = new Intent(MainActivityNew04042018.this, FaqActivity.class);
                            ...
                            case 5:
                                ...
                                MaterialDialog dialog = new MaterialDialog.Builder(MainActivityNew04042018.this)
                                        .content("Your Earned Points: " + userDetailsPref.getIntPref(MainActivityNew04042018.this, UserDetailsPref.USER_TOTAL_AMOUNT))
                                        .positiveColor(getResources().getColor(R.color.primary_text2))
                            ...
                            case 7:
                                Intent intentEnquiry = new Intent(MainActivityNew04042018.this, EnquiryActivity.class);
                                startActivity(intentEnquiry);
                                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
                                break;

                            case 8:
                                Intent intent = new Intent(MainActivityNew04042018.this, ScoreListActivity.class);
                                startActivity(intent);
                                overridePendingTransition (R.anim.slide_in_left, R.anim.slide_out_right);
                                break;
...
//        result.getActionBarDrawerToggle ().setDrawerIndicatorEnabled (false);
    ...
    private void showLogOutDialog() {
        MaterialDialog dialog = new MaterialDialog.Builder(this)
                ...
                .typeface(SetTypeFace.getTypeface(MainActivityNew04042018.this), SetTypeFace.getTypeface(MainActivityNew04042018.this))
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    @Override
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        ...
                        userDetailsPref.putStringPref(MainActivityNew04042018.this, UserDetailsPref.USER_EMAIL, "");
